...
const About = () => {
  ...
  return <section id="about" className="relative py-20 overflow-hidden bg-transparent">
      ...
      <div className="absolute bottom-10 left-20 text-primary/20 text-8xl font-bold animate-float" style={{
      animationDelay: '1s'
    }}>{'}'}</div>
            ...
            <CardContent className="p-6 sm:p-8">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground leading-relaxed">Focused on becoming a full-stack software engineer by building production-ready MERN applications and gaining hands-on exposure to DevOps practices for scalable system development.</p>
                </div>
              </div>
            </CardContent>
          </Card>
