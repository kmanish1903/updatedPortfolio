    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-background">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
          ...
          <div className="flex-1 text-center lg:text-left animate-fade-in-up text-accent-foreground order-2 lg:order-1">
            {/* Greeting with wave animation */}
            <div className="text-lg sm:text-xl text-muted-foreground mb-4 flex items-center justify-center lg:justify-start gap-2">
              <span>Hello, I'm</span>
            ...
            <div className="text-base sm:text-lg md:text-xl text-muted-foreground mb-8 max-w-3xl mx-auto lg:mx-0 px-4 lg:px-0 flex flex-col sm:flex-row items-center justify-center lg:justify-start text-center lg:text-left gap-1 sm:gap-0">
